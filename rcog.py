...
# Input argument
parser.add_argument('--input',type=str, help='Path to input image or video file. Skip this argument to capture frames from a camera.')
# Model argument
...
#cv.imwrite
print("out-{}".format(args.input),frame)
